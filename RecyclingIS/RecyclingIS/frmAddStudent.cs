...
namespace RecyclingIS
{
    ...
    {
        string ConStr = @"Data Source=Rams\SQLEXPRESS;Initial Catalog=RecyclingIS;Integrated Security=True;Encrypt=True;TrustServerCertificate=True"; public frmAddStudent()
        {
            InitializeComponent();
            SetupForm();
        }
